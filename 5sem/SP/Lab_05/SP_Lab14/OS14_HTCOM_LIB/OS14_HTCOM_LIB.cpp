...
namespace OS14
{
	...
	namespace Manipulator
	{
		...
		HTHANDLE* Open(OS14HANDEL h, const wchar_t* fileName, bool isMapFile)
		{
			IHTManipulator* pIManipulator = nullptr;
			HRESULT hr0 = ((IUnknown*)h)->QueryInterface(IID_IHTManipulator, (void**)&pIManipulator);
		...
		HTHANDLE* Open(OS14HANDEL h, const wchar_t* HTUser, const wchar_t* HTPassword, const wchar_t* fileName, bool isMapFile)
		{
			IHTManipulator* pIManipulator = nullptr;
			HRESULT hr0 = ((IUnknown*)h)->QueryInterface(IID_IHTManipulator, (void**)&pIManipulator);

...
BEGIN_MESSAGE_MAP(COKGlaba3App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &COKGlaba3App::OnAppAbout)
END_MESSAGE_MAP()


// Создание COKGlaba3App

COKGlaba3App::COKGlaba3App() noexcept
{
	...
	SetAppID(_T("OKGlaba3.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект COKGlaba3App

COKGlaba3App theApp;


// Инициализация COKGlaba3App

BOOL COKGlaba3App::InitInstance()
{
...
// Обработчики сообщений COKGlaba3App
